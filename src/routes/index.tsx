...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://aiprofigrup.ru/__l5e/assets-v1/186177fd-296a-4506-af67-9c63e3a0665f/og-home.jpg" },
      { name: "twitter:image", content: "https://aiprofigrup.ru/__l5e/assets-v1/186177fd-296a-4506-af67-9c63e3a0665f/og-home.jpg" },
    ],
