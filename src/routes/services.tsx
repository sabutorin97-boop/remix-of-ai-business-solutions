...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://aiprofigrup.ru/services" },
      { property: "og:image", content: "https://aiprofigrup.ru/__l5e/assets-v1/70fcce3d-0e5e-44c0-b718-ca2d1c5c2647/og-services.jpg" },
      { name: "twitter:image", content: "https://aiprofigrup.ru/__l5e/assets-v1/70fcce3d-0e5e-44c0-b718-ca2d1c5c2647/og-services.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://aiprofigrup.ru/services" }],
  }),
  component: () => (
    <>
