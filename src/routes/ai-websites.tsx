...
export const Route = createFileRoute("/ai-websites")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://ai-profigrup-studia.lovable.app/ai-websites" },
      { property: "og:image", content: "https://ai-profigrup-studia.lovable.app/__l5e/assets-v1/9c0b85e9-74df-4d79-b41f-1bd89f33f395/og-ai-websites.jpg" },
      { name: "twitter:image", content: "https://ai-profigrup-studia.lovable.app/__l5e/assets-v1/9c0b85e9-74df-4d79-b41f-1bd89f33f395/og-ai-websites.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://ai-profigrup-studia.lovable.app/ai-websites" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://ai-profigrup-studia.lovable.app/ai-websites",
        }),
      },
    ],
  }),
