        ...
        <div className="mt-10 space-y-8 text-sm md:text-base leading-relaxed text-foreground/90">
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              обеспечению их безопасности в соответствии с{" "}
              <a
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              техническую работу сайта (хостинг, аналитика), а также AI-провайдера,
              обрабатывающего сообщения, отправленные через чат-виджет на сайте, — на условиях
              конфиденциальности.
            </p>
          </section>
