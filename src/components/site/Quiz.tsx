...
const steps = [
  ...
  { q: "Что нужно сделать?", options: ["Сайт с нуля", "Переделать существующий", "Telegram-бот", "Авито под ключ", "Полную систему"] },
  ...
  { q: "Нужны интеграции?", options: ["CRM", "Telegram + оплаты", "Аналитика", "Авито", "Пока не знаю"] },
