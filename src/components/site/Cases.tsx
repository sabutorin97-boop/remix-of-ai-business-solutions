...
const cases: Case[] = [
  ...
  },
  {
    cat: "CRM",
    tag: "Автоматизация",
    metric: "2 сайта + AI-консультант + CRM на своём сервере",
    client: "Окна ПрофиГрупп · Курган",
    title: "Полная автоматизация оконной компании: сайт + AI-бот + CRM",
    tags: ["Сайт", "AI-консультант", "CRM", "Приём заявок", "Свой сервер"],
    description:
      "Связка из двух сайтов и CRM: основной сайт с AI-консультантом Max, который отвечает на вопросы посетителей прямо на странице, и лендинг с квизом — оба подключены к общей CRM. Заявки с обоих сайтов автоматически попадают в воронку, менеджер видит их в одном месте. Вся инфраструктура — на собственном сервере клиента, без привязки к сторонним платформам.",
