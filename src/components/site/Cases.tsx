...
const cases: Case[] = [
  {
    ...
    metric: "Карточка товара за 10 секунд",
    client: "КартаТовара AI",
    title: "КартаТовара AI — генератор карточек для маркетплейсов",
    tags: ["GPT-4o", "DALL-E", "Wildberries", "Ozon", "Яндекс Маркет"],
    description:
  ...
  },
  {
    cat: "Сайты",
    tag: "Сайт",
    metric: "Лендинг с квизом за 1 минуту",
    client: "Оконная компания",
    title: "Сайт для оконной компании",
    tags: ["Лендинг", "Квиз", "Окна", "Адаптивный", "Заявки"],
    description:
      "Лендинг с квизом: посетитель отвечает на несколько вопросов и сразу получает подобранную комплектацию окна. Чистый дизайн, быстрая загрузка, полная адаптивность под мобильные устройства.",
    url: "https://окна-курган-профигруп.рф",
    featured: true,
    image: "/cases/warm-website.jpg",
  },
  {
    cat: "CRM",
    tag: "Автоматизация",
    metric: "Сайт + AI-консультант + CRM на своём сервере",
    client: "ПРОФИГРУПП · окна ПВХ, Курган",
    title: "Полная автоматизация оконной компании: сайт + AI-бот + CRM",
    tags: ["Сайт", "AI-консультант", "CRM", "Канбан-воронка", "Свой сервер"],
    description:
      "Связка сайта и CRM для официального дистрибьютора уральского завода окон (Курган, работают с 2015 года): AI-консультант Max отвечает на вопросы прямо на сайте, а заявки с сайта и с лендинга-квиза автоматически попадают на канбан-доску (Новый → Расчёт отправлен → Думает → Выигран). Вся инфраструктура — на собственном сервере клиента, без привязки к сторонним платформам.",
    url: "https://okna-kurgan-profigrup.ru",
    featured: true,
  ...
  },
  {
    cat: "Сайты",
    tag: "Сайт",
    metric: "Кухни на заказ под ключ за 45 дней",
    client: "Зауральский мастер · фабрика кухонь, Курган",
    title: "Сайт для фабрики кухонь на заказ",
    tags: ["Лендинг", "Каталог", "Запись на замер", "С 2004 года"],
    description:
  ...
  },
  {
    ...
    client: "AI-Profigrup · собственный кейс",
    title: "Автономный AI-агент на сервере заказчика",
    tags: ["OpenAI", "Claude", "24/7", "Автономный сервер", "Индивидуальные сценарии"],
    description:
  ...
  },
  {
    cat: "Telegram-боты",
    tag: "Наш бот",
    metric: "AI-генерация картинок за секунды",
    client: "AI-Profigrup · собственный кейс",
    title: "PixSpark AI — Telegram-бот для генерации изображений",
  ...
  },
  {
    cat: "AI-агенты",
    tag: "Наш бот",
    metric: "Живой диалог 24/7 + эскалация владельцу",
    client: "AI-Profigrup · собственный кейс",
    title: "Азимут — AI-консультант отдела продаж",
    tags: ["Telegram", "Живой диалог", "Эскалация", "База знаний услуг"],
    description:
      "Тот самый бот, на который переключает виджет Макс на этом же сайте после пары ответов. Отвечает по актуальным ценам и услугам, ведёт диалог до результата и уведомляет владельца о новых обращениях.",
    url: "https://t.me/AIProfigrupConsultant_bot",
    featured: true,
  },
  {
    cat: "AI-агенты",
    tag: "Наш бот",
    metric: "Автономная работа 24/7",
    client: "AI-Profigrup · собственный кейс",
    title: "Nexus — личный AI-ассистент с командой суб-агентов",
    tags: ["Мультиагентная система", "Контент-план", "Автопубликация", "Календарь"],
    description:
      "Не просто чат-бот, а координатор команды из нескольких специализированных агентов: сам находит инфоповоды, готовит контент-план на неделю, автономно ведёт блог этого сайта (см. свежие статьи) и управляет календарём.",
    featured: true,
  },
