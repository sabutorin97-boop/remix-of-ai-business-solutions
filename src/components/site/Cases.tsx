...
const cases: Case[] = [
  ...
  },
  {
    cat: "Сайты",
    tag: "Сайт",
    metric: "Сайт для оконной компании",
    client: "Оконная компания",
    title: "Сайт для оконной компании",
    tags: ["Лендинг", "Окна", "Адаптивный", "Заявки"],
    description:
      "Современный сайт для оконной компании: каталог конструкций, расчёт стоимости, форма заявки. Чистый дизайн, быстрая загрузка, полная адаптивность под мобильные устройства.",
    url: "https://warm-website-workshop.lovable.app",
    featured: true,
  ...
  },
  {
    cat: "CRM",
    tag: "Автоматизация",
    metric: "Сайт + AI-бот + CRM",
    client: "Оконная компания",
    title: "Полная автоматизация оконной компании: сайт + AI-бот + CRM",
    tags: ["Сайт", "AI-бот", "CRM", "База знаний", "Автоматизация"],
    description:
      "Связка для оконной компании: сайт warm-website-workshop с продающим AI-чат-ботом консультантом на базе знаний по продукту и подключённой CRM. Лиды с сайта и из чата автоматически попадают в воронку, менеджеры видят всю историю переписки.",
    url: "https://pixel-perfect-clone-82870.lovable.app",
    featured: true,
