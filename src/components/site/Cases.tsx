...
const cases: Case[] = [
  ...
  },
  {
    ...
    description:
      "Операционный агент развёртывается на сервере заказчика и работает 24/7 без привязки к облачным SaaS. Самообучается под задачи бизнеса, сам выполняет рутинные операции и интегрируется с сайтом, Telegram-ботом или CRM. Консультант советует — агент действует.",
    url: "https://t.me/AiProfiGrup_bot",
    featured: true,
