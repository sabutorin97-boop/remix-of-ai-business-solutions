...
const cases: Case[] = [
  ...
  },
  {
    cat: "Сайты",
    tag: "Сайт",
    metric: "Лендинг для веб-мастерской",
    client: "Warm Website Workshop",
    title: "Сайт для творческой веб-мастерской",
    tags: ["Лендинг", "Сайт", "Адаптивный"],
    description:
      "Современный лендинг для веб-мастерской: чистый дизайн, быстрая загрузка, полная адаптивность. Отражает уютный и профессиональный стиль студии.",
  ...
  },
  {
    ...
    client: "Warm Website Workshop",
    title: "Полная автоматизация: сайт, AI-консультант и CRM",
    tags: ["Сайт", "AI-бот", "CRM", "Автоматизация", "База знаний"],
    description:
      "Комплексное решение: сайт с AI-чат-ботом консультантом на базе знаний, интегрированный с CRM-системой. Лиды собираются автоматически, передаются в воронку, менеджеры видят всю историю общения.",
    url: "https://pixel-perfect-clone-82870.lovable.app",
    featured: true,
