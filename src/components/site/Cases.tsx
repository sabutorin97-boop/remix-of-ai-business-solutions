...
const cases: Case[] = [
  ...
  },
  {
    cat: "Сайты",
    tag: "Сайт",
    metric: "Официальный дистрибьютор завода",
    client: "ПРОФИГРУПП · окна ПВХ, Курган",
    title: "Сайт для компании по продаже окон",
    tags: ["Лендинг", "Окна ПВХ", "Расчёт стоимости", "Заявки"],
    description:
      "Сайт для официального дистрибьютора уральского завода окон (Курган и область, работают с 2015 года): каталог, расчёт стоимости, форма заявки на замер.",
    url: "https://warm-website-okna-profigrupp.lovable.app",
    featured: true,
  ...
  },
  {
    cat: "CRM",
    tag: "Автоматизация",
    metric: "Сайт + CRM с AI-онбордингом",
    client: "ПРОФИГРУПП · окна ПВХ, Курган",
    title: "Автоматизация продаж окон: сайт + CRM с AI внутри",
    tags: ["Сайт", "CRM", "AI-онбординг", "Канбан-воронка", "Автоматизация"],
    description:
      "Связка сайта и CRM для той же компании: лиды с сайта автоматически попадают на канбан-доску (Новый → Расчёт отправлен → Думает → Выигран), а встроенный в CRM AI ведёт первичный онбординг и общение с клиентом ещё до подключения менеджера.",
    url: "https://pixel-perfect-clone-82870.lovable.app/board",
    featured: true,
